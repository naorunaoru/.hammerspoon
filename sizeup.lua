...
--- Snapback Action ---
hs.hotkey.bind(m1, "Z", function()
  sizeup.snapback()
end)
-- --- Other Actions ---
-- -- Make Window Full Screen
hs.hotkey.bind(m1, "f", function()
  sizeup.maximize()
end)
-- Send Window Center
hs.hotkey.bind(m1, "P", function()
  sizeup.move_to_center_absolute({w=960, h=600})
